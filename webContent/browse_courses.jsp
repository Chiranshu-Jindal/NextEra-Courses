...
List<Course> courses = coursedao.getAllPublishedCourses();
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Browse Courses - Nexteracourses</title>
<!-- CSS -->
<link rel="stylesheet"
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark primary-background">
		<a class="navbar-brand" href="index.jsp"><span><img
				src="img/logo.png" width="60"></span> NextEra Courses</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link" href="#"> <span
						class="fa fa-graduation-cap"></span> Home <span class="sr-only">(current)</span></a></li>
	...
	<div class="container mt-5">
		...
		<div class="row">
			...
			%>
			<div class="col-md-4">
				<div class="card shadow-sm mb-4 course-card">
					<div class="card-body">
						<h5 class="card-title"><%=course.getTitle()%></h5>
						<p class="card-text"><%=course.getDescription()%></p>
						<p>
							<strong>Category:</strong>
							<%=course.getCategory()%></p>
						<p>
							<strong>Price:</strong> $<%=course.getPrice()%></p>
